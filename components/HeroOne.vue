                    ...
                    <div class="col-md-6 col-lg-6 col-xl-7">
                        <div class="content">
                            <div class="subtitle-content">
                                ...
                                <h6>Vamos anunciar Jesus Cristo!</h6>
                            </div>
                            <div class="tittle-wrp">
                                <h2>Ide por todo o mundo, pregai o evangelho a toda <span>criatura</span>.</h2>
                            </div>
                            <div class="btn-wrp">
                                ...
                                <nuxt-link to="/contato" class="btn-theme btn-border btn-black btn-style">
                                    Contate-nos 
                        ...
                        <div class="layer-style">
                            ...
                            <div class="donate-circle-wrp">
                                <div class="donate-content">
                                    <div class="raised-amount">José Aparecido</div>
                                    <img class="line-shape-img" src="/images/shape/line-s2.png" alt="Image">
                                    <h5 class="donate-title">Pr. Local</h5>
                                </div>
                            </div>
                        </div>
                    </div>
